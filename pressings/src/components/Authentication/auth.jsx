        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          >
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <motion.button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-medium py-2.5 px-4 rounded-lg shadow-md hover:from-blue-700 hover:to-indigo-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all"
                disabled={isLoading}
          ...
          <div className="px-8 py-4 bg-gray-50 border-t border-gray-200 text-center">
            <p className="text-xs text-gray-600">
              &copy; {new Date().getFullYear()} Contour Wash. Tous droits réservés. | <Link to="/terms" className="text-blue-600 hover:text-blue-800">Conditions d'utilisation</Link> | <Link to="/privacy" className="text-blue-600 hover:text-blue-800">Politique de confidentialité</Link>
            </p>
          </div>
        </div>
      </motion.div>
